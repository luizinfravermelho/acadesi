...
public class Login extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(log)
                    .addComponent(sen, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void logFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_logFocusGained
        //Quando clicar na caixa de login, o placeholder some pro usuário digitar sua matrícula
        if (log.getText().equals("Matrícula ou CPF")) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (log.getText().equals("") || sen.getText().equals("")) { //Verifica se tem algum campo não preenchido
            ...
            new Agendamento().setVisible(true); //Abre a tela de agendamento
    ...
    public static javax.swing.JPasswordField sen;
